...
public class App {
    ...
    public void addItem() {
        ...
        while (choice != 99) {
            ...
            System.out.println("7. Add Vinyl");
            System.out.println("8. Add Digital Music");
            ...
            switch(choice) {
                ...
                case 7: item = new Vinyl(); break;
                case 8: item = new DigitalMusic(); break;
    ...
    public void listAny() {
        ...
        while (choice != 99) {
            ...
            System.out.println("8. Vinyls");
            System.out.println("9. Digital Musics");
            System.out.println("99. Exit");
            ...
            switch(choice) {
                ...
                case 8: filter = Vinyl.class; break;
                case 9: filter = DigitalMusic.class; break;
                default: System.out.println("Invalid selection."); continue;
            }
    ...
    public void populate() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            Vinyl v = new Vinyl(
                    ...
                    faker.number().randomDouble(2,10,999),
                    faker.color().name(),
                    faker.number().numberBetween(5,30)
            );
            addItem(v);
            ...
            // Digital Music
            DigitalMusic d = new DigitalMusic(
                    faker.funnyName().name(),
                    faker.rockBand().name(),
                    faker.music().genre(),
                    faker.number().numberBetween(1990,2026),
